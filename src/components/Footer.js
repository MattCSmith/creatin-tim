    ...
    <div className="row">
        ...
        <div className="credits ml-auto">
            <span className="copyright" >
                © {(new Date().getFullYear())}, themed with <i className="fa fa-heart heart"></i> by <a href="https://www.creative-tim.com" target="_blank" rel="noopener noreferrer"> Creative Tim </a>
            </span>
        </div>
    </div>
</div>
